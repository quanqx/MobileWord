...
namespace MobileWorld.Areas.Admin.Controllers
{
    public class ChiTietDonHangsController : Controller
    {
        ...
        {
            ViewBag.MaDonHang = new SelectList(db.DonHangs, "MaDonHang", "Email");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDonHang,MaSP,SoLuong")] ChiTietDonHang chiTietDonHang)
        {
            if (ModelState.IsValid)
            {
